...
The results of a logistic regression suggest that the odds of a lizard having a whole tail are greater when the snout-to-vent length is lower () and the lizard is located in the black grama grassland () or tarbush shrubland () zone.
